...
var Facehugger = function(options) {
    ...
    return function(req, res, next) {
      if (req.body.signed_request) {
        self.parse_signed_request(req.body.signed_request, function(token) {
          req.facebook = new FacehuggerSession(self, token);
          next();
        });
        ...
        req.facebook = new FacehuggerSession(self);
        next();
      }
    }
  }
...
var FacehuggerSession = function(hugger, token) {
  ...
  this.app = function(cb) {
    self.get('/' + self.hugger.app_id, function(app) {
      cb(app);
    });
  }
...
module.exports.middleware = function(options) {
  return new Facehugger(options).middleware();
}
